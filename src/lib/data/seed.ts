...
export const seedUsers: User[] = [
  ...
  ...[
    { name: "João Pereira", placa: "ABC-1D23", veiculo: "Scania R450" },
    { name: "Marcos Silva", placa: "DEF-4E56", veiculo: "Volvo FH 540" },
    { name: "Ricardo Alves", placa: "GHI-7F89", veiculo: "Mercedes Actros" },
    { name: "Paulo Souza", placa: "JKL-0G12", veiculo: "Iveco Stralis" },
    { name: "Carlos Nunes", placa: "MNO-3H45", veiculo: "DAF XF" },
  ].map((m, i): User => ({
    id: `MOT-000${i + 1}`,
    number: `MOT-000${i + 1}`,
    type: "motorista",
